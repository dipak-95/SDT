...
const AdminGroupTour = () => {
  ...
  const fetchTours = async () => {
    const res = await axios.get("https://sdt-7.onrender.com/group-tours");
    setTours(res.data);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        /* UPDATE TOUR */
        res = await axios.put(
          `https://sdt-7.onrender.com/group-tours/${editingId}`,
          fd
        );
        ...
        res = await axios.post(
          "https://sdt-7.onrender.com/group-tours",
          fd
        );
  ...
  const handleDelete = async (id) => {
    ...
    await axios.delete(`https://sdt-7.onrender.com/group-tours/${id}`);

...
//       refresh();
//     } catch (err) {
//       console.error("Add rooms failed", err);
...
//     hotel.rooms?.reduce(
//       (sum, r) => sum + (r.totalRooms - r.bookedRooms),
//       0
//     ) || 0;
...
//                              bg-white/80 px-2 py-1 rounded-full shadow"
//                 >
//                   ‹
//                 </button>
//                 <button
...
//           className="mt-3 w-full bg-[#F4612B] text-white py-2 rounded"
//         >
//           ➕ Add More Rooms
//         </button>
//       )}
